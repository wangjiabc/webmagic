...
public class BaiduBaikePageProcessor implements PageProcessor {
 ...
 //           .setRetryTimes(3).setSleepTime(1000).setUseGzip(true);
    ...
    public static void main(String[] args) {
        //single download
       Spider spider = Spider.create(new BaiduBaikePageProcessor()).addPipeline(new JsonFilePipeline("C:\\Users\\WangJing\\Desktop\\aaaaaaaaaaaa")).thread(2);
        String urlTemplate = "http://baike.baidu.com/search/word?word=%s&pic=1&sug=1&enc=utf8";
        ResultItems resultItems = spider.<ResultItems>get(String.format(urlTemplate, "泸州"));
